param(
  ...
  [string]$KeyStorePath, [string]$SecretPath, [string]$ExpectedBuildId, [string]$ExpectedMcpVersion = '1.2.1',
  [string]$ExpectedContractVersion = 'learning-content-v8.1', [int]$ExpectedToolCount = 34,
